...
@AllArgsConstructor
@Data
public class RegisterUserResponse extends UserDTO {
    private List<SubjectDTO> subjects = new ArrayList<>();

    public RegisterUserResponse(Long userId, String username, String name, String email, String phone, List<SubjectDTO> subjects) {
        super(userId, username, name, email, phone);
        this.subjects = subjects;
    }

    public static RegisterUserResponse responseWithSubject(User user) {
